...
class BookingAPIClient(BaseAPIClient):
    ...
    def get_auth_token(self, username: str, password: str) -> str:
        ...
        response = self._make_request('POST', '/auth', json=auth_data)
    ...
    def create_booking(self, booking_data: Dict[str, Any]) -> int:
    ...
    def partial_update_booking(self, booking_id: int, updates: Dict[str, Any]) -> Dict[str, Any]:
    ...
    def update_booking_without_auth(self, booking_id: int, booking_data: Dict[str, Any]) -> Dict[str, Any]:
